...
import { MapPin, Globe, Users, Flag, Heart, ChevronRight } from "lucide-react";
import { useTheme } from "@/components/ThemeProvider";
import Link from "next/link";

const communityLevels = [
    { title: "Your Area", icon: MapPin, desc: "Lead your neighborhood", href: "/community-area-head" },
    { title: "Your Zone", icon: Globe, desc: "Manage your local zone", href: "/community-zone-head" },
    { title: "Your City", icon: Users, desc: "Influence your whole city", href: "/community-city-head" },
    { title: "Your State", icon: Flag, desc: "Represent your state", href: "/community-state-head" },
    { title: "Your India", icon: Heart, desc: "A national visionary", href: "/community-india-head" },
];
