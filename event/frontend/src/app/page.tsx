...
export default function EventLandingPage() {
    return (
        <div className="bg-[#f8fafc] text-slate-900 selection:bg-sky-500/30 overflow-x-hidden min-h-screen">
            ...
            {/* Hero Section */}
            <section className="relative flex flex-col justify-start pt-[80px] lg:pt-[100px] min-[1300px]:pt-[50px] pb-10 overflow-hidden min-h-screen">
                ...
                <div className="relative z-10 max-w-7xl mx-auto w-full px-8 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                    ...
                    {/* LEFT: Text Content */}
                    <div className="flex flex-col items-start lg:-mt-12 xl:-mt-24 min-[1300px]:-mt-32">
                        <motion.div
                    ...
                    <div className="w-full h-[350px] sm:h-[450px] md:h-[500px] lg:h-[550px] xl:h-[600px] relative z-20 mt-4 md:mt-0 lg:-mt-10 xl:-mt-20 min-[1300px]:-mt-32">
